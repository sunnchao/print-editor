<script setup lang="ts">
  ...
  function handlePreview() {
    ...
    if (templateId.value) {
      // 先保存再预览
      handleSave().then(() => {
        window.open(`/preview/${templateId.value}?popup=1`, '_blank')
      })
    } else {
  ...
  <div class="editor-page">
    ...
    <div class="editor-toolbar">
      <div class="toolbar-left">
        ...
        <a-input v-model:value="templateName" class="template-name-input" placeholder="模板名称" />
      </div>
      ...
      <div class="toolbar-right">
        <a-space>
          ...
          <a-dropdown>
            ...
            <template #overlay>
              <a-menu>
                <a-menu-item key="json" @click="handleExportJson"> 导出模板</a-menu-item>
    ...
    <!-- 隐藏的打印 iframe -->
    <iframe ref="printIframeRef" class="print-iframe" />
